...
<template>
  <aside class="explorer-sidebar" data-ui-region="vault-panel">
    ...
    <label class="vault-tree-filter">
      ...
      <input
        v-model="uiState.noteFilter"
        placeholder="Filter files…"
        aria-label="Filter vault files"
      >
      <button
        v-if="uiState.noteFilter"
        type="button"
        aria-label="Clear filter"
        @click="uiState.noteFilter = ''"
      >
    ...
    <Transition name="collapse-fade">
      <form
        v-if="folderInputOpen"
        class="new-folder-form explorer-new-folder-form"
    ...
    <div class="explorer-scroll">
      <section class="explorer-section smart-folders">
        <button
          type="button"
          :class="{ active: uiState.notesView === 'editor' && vaultState.selectedFolderId === 'all' }"
        ...
        <button
          type="button"
          :class="{ active: uiState.notesView === 'editor' && vaultState.selectedFolderId === 'recent' }"
        ...
        <button
          type="button"
          :class="{ active: uiState.notesView === 'editor' && vaultState.selectedFolderId === 'favorites' }"
