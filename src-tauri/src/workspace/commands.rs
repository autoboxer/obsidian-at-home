...
#[tauri::command(rename_all = "camelCase")]
pub async fn workspace_archive_note(
    app: AppHandle,
    path: String,
    vault: VaultData,
    note: Note,
...
#[tauri::command(rename_all = "camelCase")]
pub async fn workspace_restore_recently_deleted_note(
    app: AppHandle,
    path: String,
...
#[tauri::command(rename_all = "camelCase")]
pub async fn workspace_delete_recently_deleted_notes(
    app: AppHandle,
    path: String,
...
#[tauri::command(rename_all = "camelCase")]
pub async fn workspace_prune_recently_deleted_notes(
    app: AppHandle,
    path: String,
    expected_revision: u64,
) -> Result<WorkspaceRecoveryMutationResult, String> {
...
pub async fn workspace_forget(
    app: AppHandle,
    path: String,
) -> Result<Vec<VaultDescriptor>, String> {
    run_vault_io(move || {
        let _guard = lock_workspace_io()?;
        let mut registry = read_registry(&app)?;
...
#[tauri::command]
pub async fn workspace_revision(app: AppHandle, path: String) -> Result<u64, String> {
    run_vault_io(move || {
        let _guard = lock_workspace_io()?;
        let root = validate_workspace_root(&path)?;
        reject_home_vault(&app, &root)?;
...
#[tauri::command(rename_all = "camelCase")]
pub async fn workspace_embed_image_file(
    app: AppHandle,
    path: String,
    source_path: String,
...
#[tauri::command(rename_all = "camelCase")]
pub async fn workspace_embed_vault_image(
    app: AppHandle,
    path: String,
...
#[tauri::command(rename_all = "camelCase")]
pub async fn workspace_embed_attachment_file(
    app: AppHandle,
    path: String,
    source_path: String,
    note_relative_path: String,
...
#[tauri::command(rename_all = "camelCase")]
pub async fn workspace_begin_external_file_upload(
    app: AppHandle,
    path: String,
    file_name: String,
    byte_length: u64,
...
#[tauri::command(rename_all = "camelCase")]
pub async fn workspace_append_external_file_upload(
...
#[tauri::command(rename_all = "camelCase")]
pub async fn workspace_cancel_external_file_upload(upload_id: String) -> Result<bool, String> {
    run_vault_io(move || cancel_external_file_upload(&upload_id)).await
}

#[tauri::command(rename_all = "camelCase")]
pub async fn workspace_finish_external_image_upload(
    app: AppHandle,
    upload_id: String,
    settings: ImageEmbedSettings,
    expected_revision: u64,
...
#[tauri::command(rename_all = "camelCase")]
pub async fn workspace_finish_external_attachment_upload(
    app: AppHandle,
    upload_id: String,
    settings: AttachmentEmbedSettings,
    expected_revision: u64,
...
#[tauri::command(rename_all = "camelCase")]
pub async fn workspace_discard_external_asset(
    app: AppHandle,
    path: String,
    asset_id: String,
...
#[tauri::command(rename_all = "camelCase")]
pub async fn workspace_embed_vault_attachment(
    app: AppHandle,
    path: String,
...
#[tauri::command(rename_all = "camelCase")]
pub async fn workspace_delete_asset(
    app: AppHandle,
    path: String,
    kind: ExternalFileUploadKind,
    relative_path: String,
...
#[tauri::command(rename_all = "camelCase")]
pub async fn workspace_relocate_image(
    app: AppHandle,
    path: String,
    image_relative_path: String,
...
#[tauri::command(rename_all = "camelCase")]
pub async fn workspace_relocate_attachment(
    app: AppHandle,
    path: String,
    attachment_relative_path: String,
    target_relative_path: String,
...
#[tauri::command(rename_all = "camelCase")]
pub async fn workspace_locate_vault_item(
    app: AppHandle,
    path: String,
...
#[tauri::command(rename_all = "camelCase")]
pub async fn workspace_show_vault_item_in_folder(
    app: AppHandle,
    path: String,
    kind: WorkspaceVaultItemKind,
    relative_path: String,
...
#[tauri::command(rename_all = "camelCase")]
pub async fn workspace_open_attachment(
    app: AppHandle,
    path: String,
    attachment_relative_path: String,
    asset_id: Option<String>,
...
#[tauri::command(rename_all = "camelCase")]
pub async fn workspace_embed_image_bytes(
    app: AppHandle,
    request: tauri::ipc::Request<'_>,
) -> Result<WorkspaceEmbedImageResult, String> {
    let encoded_metadata = request
...
#[tauri::command(rename_all = "camelCase")]
pub async fn workspace_import_images(
    app: AppHandle,
    path: String,
    source_path: String,
...
#[tauri::command(rename_all = "camelCase")]
pub async fn workspace_import_assets(
    app: AppHandle,
    path: String,
    source_path: String,
    image_paths: Vec<String>,
...
#[tauri::command(rename_all = "camelCase")]
pub async fn workspace_save_editor_positions(
    app: AppHandle,
    path: String,
